...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MZStreamNetwork",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC15MZStreamNetwork12TrafficAlert")
...
@interface TrafficAlert (SWIFT_EXTENSION(MZStreamNetwork))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC15MZStreamNetwork14TrafficMonitor")
...
SWIFT_CLASS("_TtC15MZStreamNetwork14TrafficSummary")
...
SWIFT_CLASS("_TtC15MZStreamNetwork9WebSocket")
...
@interface WebSocket (SWIFT_EXTENSION(MZStreamNetwork))
...
SWIFT_PROTOCOL("_TtP15MZStreamNetwork17WebSocketDelegate_")
@protocol WebSocketDelegate
